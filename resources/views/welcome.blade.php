        ...
        <aside v-show="$route.path === '/' ? false : true" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main" style="display: none;">
            <div class="sidenav-header">
              ...
              <a class="navbar-brand m-0" href="#">
                <img src="{{ asset('imgKasir/logo.jpeg') }}" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold text-white">Enigma Kopi</span>
              </a>
            </div>
            <hr class="horizontal light mt-0 mb-2">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <router-link class="nav-link text-white " to="/transaksi">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
